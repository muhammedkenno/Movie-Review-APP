...
const APILINK = 'https://216755b3-4e37-402a-b952-44944e32409a-00-2ocb0975xchbe.pike.replit.dev/api/v1/reviews/';
...
function returnReviews(url){
  ...
  .then(function(data){
    console.log(data);
    data.forEach(review => {
        // Creating review for each movie
        ...
        div_card.innerHTML = `
          ...
          `
        main.appendChild(div_card); // Appending the card to main section
    });
  });
}
